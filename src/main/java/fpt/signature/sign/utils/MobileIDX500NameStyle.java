...
public class MobileIDX500NameStyle implements X500NameStyle {
    private static final Logger LOG = Logger.getLogger(fpt.signature.sign.utils.MobileIDX500NameStyle.class);
    ...
    public static final X500NameStyle INSTANCE = new fpt.signature.sign.utils.MobileIDX500NameStyle();
    ...
    public ASN1Encodable stringToValue(ASN1ObjectIdentifier oid, String value) {
        ...
        if (oid.equals(EmailAddress) || oid.equals(DC))
            return (ASN1Encodable)new DERIA5String(value);
        if (oid.equals(DATE_OF_BIRTH))
            return (ASN1Encodable)new ASN1GeneralizedTime(value);
        if (oid.equals(C) || oid.equals(SN) || oid.equals(DN_QUALIFIER) || oid
                .equals(TELEPHONE_NUMBER))
            return (ASN1Encodable)new DERPrintableString(value);
        return (ASN1Encodable)new DERUTF8String(value);
    }
